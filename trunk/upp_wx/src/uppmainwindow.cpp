...
UppMainWindow::UppMainWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	uppMenuProgram = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Program") ) + wxT('\t') + wxT("F7"), wxEmptyString, wxITEM_NORMAL );
	uppMenuActions->Append( uppMenuProgram );
	
	wxMenuItem* uppMenuRead;
	uppMenuRead = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Read") ) + wxT('\t') + wxT("F8"), wxEmptyString, wxITEM_NORMAL );
	uppMenuActions->Append( uppMenuRead );
	
	wxMenuItem* uppMenuVerify;
	uppMenuVerify = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Verify") ) , wxEmptyString, wxITEM_NORMAL );
	uppMenuActions->Append( uppMenuVerify );
	
	wxMenuItem* uppMenuErase;
	uppMenuErase = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Erase") ) , wxEmptyString, wxITEM_NORMAL );
	uppMenuActions->Append( uppMenuErase );
	
	wxMenuItem* uppMenuBlankCheck;
	uppMenuBlankCheck = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Blankcheck") ) , wxEmptyString, wxITEM_NORMAL );
	uppMenuActions->Append( uppMenuBlankCheck );
	
	wxMenuItem* uppMenuAutoDetect;
	uppMenuAutoDetect = new wxMenuItem( uppMenuActions, wxID_ANY, wxString( wxT("Autodetect") ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_toolBar1->AddTool( wxID_ANY, wxT("new"), wxICON( new ), wxNullBitmap, wxITEM_NORMAL, wxT("new"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("tool"), wxICON( open ), wxNullBitmap, wxITEM_NORMAL, wxT("open"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("tool"), wxICON( refresh ), wxNullBitmap, wxITEM_NORMAL, wxT("refresh"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("tool"), wxICON( save ), wxNullBitmap, wxITEM_NORMAL, wxT("save"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("tool"), wxICON( save_as ), wxNullBitmap, wxITEM_NORMAL, wxT("save as"), wxEmptyString );
	m_toolBar1->AddSeparator();
	m_toolBar1->AddTool( wxID_ANY, wxT("program"), wxICON( program ), wxNullBitmap, wxITEM_NORMAL, wxT("program"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("read"), wxICON( read ), wxNullBitmap, wxITEM_NORMAL, wxT("read"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("verify"), wxICON( verify ), wxNullBitmap, wxITEM_NORMAL, wxT("verify"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("erase"), wxICON( erase ), wxNullBitmap, wxITEM_NORMAL, wxT("erase"), wxEmptyString );
	m_toolBar1->AddTool( wxID_ANY, wxT("blankcheck"), wxICON( blankcheck ), wxNullBitmap, wxITEM_NORMAL, wxT("blankcheck"), wxEmptyString );
	m_toolBar1->AddSeparator();
	...
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_new ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_save ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_refresh ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_save ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_save_as ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_program ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_read ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_verify ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_erase ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( UppMainWindow::on_blankcheck ) );
