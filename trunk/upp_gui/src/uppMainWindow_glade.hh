...
public:
        ...
        class Gtk::ImageMenuItem * reload;
        class Gtk::ImageMenuItem * save;
        class Gtk::ImageMenuItem * save_as;
        class Gtk::MenuItem * separatormenuitem1;
        class Gtk::ImageMenuItem * quit;
        class Gtk::Menu * menuFile_menu;
        class Gtk::MenuItem * menuFile;
        class Gtk::MenuItem * program;
        class Gtk::MenuItem * bulkerase;
        class Gtk::MenuItem * read;
        class Gtk::MenuItem * verify;
...
private:
        ...
        virtual void on_newButton_activate() = 0;
        virtual void on_openButton_activate() = 0;
        virtual void on_reloadButton_activate() = 0;
        virtual void on_saveButton_activate() = 0;
};
#endif
