...
LIST( P16F54,		PIC10,	5V,		simple,		P16F59,		P16F54,		XXXX,		P16F54,		XXXX,		P16F54 )
LIST( P16F57,		PIC10,	5V,		simple,		P16F59,		P16F57,		XXXX,		P16F54,		XXXX,		P16F54 )
LIST( P16F785,		PIC16,	5V,		simple,		P16F182X,	PIC16,		PIC16,		P16F785,	P16F785,	P16F785 )
LIST( P16F59,		PIC10,	5V,		simple,		P16F59,		P16F57,		XXXX,		P16F54,		XXXX,		P16F54 )
LIST( P16F91X,		PIC16,	5V,		simple,		P16F91X,	PIC16,		PIC16,		P16F87,		P16F785,	P16F62XA )
LIST( P16F88X,		PIC16,	5V,		simple,		P16F182X,	PIC16,		PIC16,		P16F785,	PIC16,		P16F62XA )
//    Pictype,		picfamily,5V,		enter_ISCP,	bulk_erase,	read_code,	read_data,	write_code,	write_data,	write_config_bits )
...
LIST( P18F6XJXX,	PIC18J,	3V,		PIC18J,		XXXX,		PIC18,		XXXX,		XXXX,		PIC18J,		XXXX )
LIST( P18F45J10,	PIC18J,	3V,		PIC18J,		P18F97J60,	PIC18,		XXXX,		P18F45J10,	PIC18J,		XXXX )
LIST( P18F97J60,	PIC18J,	3V,		PIC18J,		P18F97J60,	PIC18,		XXXX,		P18F45J10,	PIC18J,		XXXX )
...
LIST( P24FJXXXGA0XX,	PIC24,	3V,		PIC18J,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX )
//    Pictype,		picfamily,5V,		enter_ISCP,	bulk_erase,	read_code,	read_data,	write_code,	write_data,	write_config_bits )
LIST( P24FJXXXGA1,	PIC24,	3V,		PIC18J,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX )
LIST( dsP30F,		dsPIC30,5V,		dsP30F,		dsP30F,		dsPIC30,	dsPIC30,	dsP30F,		dsPIC30,	dsP30F )
LIST( dsP33F,		dsPIC33,5V,		simple,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX )
LIST( P24H,		PIC24,	3V,		PIC18J,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX,		XXXX )
LIST( P10F200,		PIC10,	5V,		simple,		P10F200,	P10F200,	XXXX,		P16F54,		none,		P16F54 )
LIST( P10F202,		PIC10,	5V,		simple,		P10F202,	P16F54,		XXXX,		P16F54,		none,		P16F54 )
...
LIST( P18FXX31,		XXXXX,	5V,		simple,		P18FX220,	XXXX,		XXXX,		P18FXX31,	P18FXX2,	XXXX )
LIST( P18FX220,		XXXXX,	5V,		simple,		XXXX,		XXXX,		XXXX,		P18FX220,	P18FXX2,	P18F2XXX )
...
LIST( P12F508,		PIC10,	5V,		simple,		P10F202,	XXXX,		XXXX,		P16F54,		XXXX,		P16F54 )
LIST( P24FXXKAXXX,	PIC24,	3V,		PIC18J,		P24KA,		XXXX,		XXXX,		P24FXXKAXXX,	XXXX,		XXXX )
...
LIST( P18F872X,		XXXXX,	5V,		simple,		P18F872X,	XXXX,		XXXX,		P18F872X,	XXXX,		P18F2XXX )
LIST( P16F182X,		PIC18,	5V,		simpleX,	P16F182X,	P16F182X,	PIC18,		P16F182X,	PIC18,		P16F62XA )
LIST( P18F6XKXX,	PIC18K,	5V,		PIC18J,		P18F6XKXX,	XXXX,		XXXX,		XXXX,		PIC18K,		XXXX )
LIST( P18F67KXX,	PIC18K,	5V,		PIC18J,		P18F67KXX,	XXXX,		XXXX,		P18F67KXX,	PIC18K,		XXXX )
//    Pictype,		picfamily,5V,		enter_ISCP,	bulk_erase,	read_code,	read_data,	write_code,	write_data,	write_config_bits )
LIST( P18F13K22,	PIC18K,	5V,		simple,		P18F13K22,	PIC18,		PIC18,		P18F13K22,	PIC18,		XXXX )
LIST( P18LF13K22,	PIC18K,	3V,		simple,		P18LF13K22,	PIC18,		PIC18,		P18LF13K22,	PIC18J,		XXXX )
LIST( P18F14K22,	PIC18K,	5V,		simple,		P18F13K22,	PIC18,		PIC18,		P18F14K22,	PIC18,		XXXX )
LIST( P18LF14K22,	PIC18K,	3V,		simple,		P18LF13K22,	PIC18,		PIC18,		P18LF14K22,	PIC18J,		XXXX )
LIST( dsP30F_LV,	dsPIC30,3V,		simpleL,	XXXX,		XXXX,		dsPIC30,	dsP30F,		dsPIC30,	dsP30F )
#else
	LIST(P18F2XXX)
	LIST(P18FXX2)
	LIST(P16F87XA)
