...
// actions
    ...
    (void)new KAction(i18n("&Compile File"), 0,
                 Qt::SHIFT + Qt::Key_F8, this, SLOT(compileFile()), actionCollection(), "build_compile_file");
    ...
    (void)new KAction(i18n("&Program"), "piklab_burnchip",
                 Qt::SHIFT + Qt::Key_F5, this , SLOT(program()), actionCollection(), "prog_program");
    (void)new KAction(i18n("&Verify"), "piklab_verifychip",
                 Qt::SHIFT + Qt::Key_F6, this , SLOT(verify()), actionCollection(), "prog_verify");
    (void)new KAction(i18n("&Read"), "piklab_readchip",
                 Qt::SHIFT + Qt::Key_F7, this , SLOT(read()), actionCollection(), "prog_read");
    ...
    // debugger actions
    (void)new KAction(i18n("&Start"), "launch",
                 Qt::SHIFT + Qt::Key_F9, Programmer::manager, SLOT(restart()), actionCollection(), "debug_start");
    ...
    (void)new KAction(i18n("&Break<Translators: it is the verb>", "&Halt"), "piklab_debughalt",
                 0, Programmer::manager, SLOT(halt()), actionCollection(), "debug_halt");
    (void)new KAction(i18n("&Disconnect/Stop"), "piklab_stop",
                 0, Programmer::manager, SLOT(disconnectDevice()), actionCollection(), "debug_stop");
...
void MainWindow::updateGUI()
{
  ...
  _programmerStatus->setText(" " + Main::programmerGroup().statusLabel(ptype) + " ");
  QFont f = font();
