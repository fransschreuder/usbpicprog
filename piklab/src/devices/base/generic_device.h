...
END_DECLARE_ENUM(Status, EnumData)

BEGIN_DECLARE_ENUM(MemoryTechnology)
  EnhancedFlash = 0, Flash, Eprom, Rom, Romless
END_DECLARE_ENUM(MemoryTechnology, EnumData)
...
END_DECLARE_ENUM(OperatingCondition, EnumData)

BEGIN_DECLARE_ENUM(Special)
  Normal = 0, LowPower, LowVoltage, HighVoltage
END_DECLARE_ENUM(Special, EnumData)
