...
#include "piklab-test/base/gputils_generator_check.h"

class GPUtilsConfigGeneratorCheck : public GPUtilsGeneratorCheck
{
Q_OBJECT
public:
  GPUtilsConfigGeneratorCheck() : _memory2(0) {}
