...
public:
  ...
  virtual bool setBreakpoints(const QValueList<uint> &addresses) = 0;
  uint pc() const;
  Register::TypeData pcTypeData() const;
  virtual bool readRegister(const Register::TypeData &data, uint &value) = 0;
  virtual bool writeRegister(const Register::TypeData &data, uint value) = 0;
