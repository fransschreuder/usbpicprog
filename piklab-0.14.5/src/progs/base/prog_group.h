...
public:
  ...
  ::Programmer::Base *createProgrammer(bool targetSelfPowered, const Device::Data *data, const Port::Description &pd) const;
...
protected:
  virtual Hardware *createHardware(::Programmer::Base &base, const Port::Description &pd) const = 0;
