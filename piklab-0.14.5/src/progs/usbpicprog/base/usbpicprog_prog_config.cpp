...
//-----------------------------------------------------------------------------
void Usbpicprog::HardwareData::readConfig(GenericConfig &config)
{
...
void Usbpicprog::HardwareData::writeConfig(GenericConfig &config) const
{
...
bool Usbpicprog::HardwareData::isEqual(const ::HProgrammer::HardwareData &cdata) const
{
...
//-----------------------------------------------------------------------------
QStringList Usbpicprog::Config::standardHardwareNames(Port::Type type) const
{
  QStringList names;
...
const HProgrammer::HardwareDataInfo *Usbpicprog::Config::standardHardwareDataInfo(const QString &name) const
{
  for (uint i=0; STANDARD_HARDWARE_DATA[i].info.name; i++) {
...
HProgrammer::HardwareData *Usbpicprog::Config::standardHardwareData(const QString &name) const
{
  for (uint i=0; STANDARD_HARDWARE_DATA[i].info.name; i++) {
    const ConstStandardHardwareData &csdata = STANDARD_HARDWARE_DATA[i];
