...
public:
  Hardware(::Programmer::Base &base, Port::Base *port, const HData &data);
  bool readBit();
...
{
public:
  SerialHardware(::Programmer::Base &base, const QString &portDevice, const HData &data);
};

class ParallelHardware : public Hardware
{
public:
  ParallelHardware(::Programmer::Base &base, const QString &portDevice, const HData &data);
};
