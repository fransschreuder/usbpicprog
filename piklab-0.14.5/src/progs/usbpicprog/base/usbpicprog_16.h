 ...
 ***************************************************************************/
#ifndef USBPICPROG_16_H
#define USBPICPROG_16_H
...
public:
  ...
  virtual uint get_byte() { return get_word() & 0xFF; }
  virtual void send_word(uint word);
  virtual void send_bits(uint d, uint nbBits);
  virtual void send_cmd(uint d) { send_bits(d, 6); }
...
protected:
  ...
  virtual uint readWord(Pic::MemoryRangeType type);
};
