...
TARGET   = xml_usbpicprog_parser
SOURCES += xml_usbpicprog_parser.cpp
...
unix:QMAKE_POST_LINK = cd ../base && ../xml/xml_usbpicprog_parser
unix:QMAKE_CLEAN += ../base/usbpicprog_data.cpp
win32:QMAKE_POST_LINK = cd ..\base && ..\xml\xml_usbpicprog_parser.exe
win32:QMAKE_CLEAN += ..\base\usbpicprog_data.cpp
