...
{
//-----------------------------------------------------------------------------
enum Command { EnterBootloader = 0x42, NoOperation = 0x5A, FirmwareVersion = 0x76,
               ...
               WriteBitesBuffer = 0xED, ReadBitsBuffer = 0xEC, ReadBits = 0xEB,
               SetIcspSpeed = 0xEA, Loop = 0xE9, DelayLong = 0xE8, DelayShort = 0xE7,
               IfEqGoto = 0xE6, IfGtGoto = 0xE5, GotoIndex = 0xE4, ExitScript = 0xE3,
               PeekSfr = 0xE2, PokeSfr = 0xE1,

               IcdSlaveRx = 0xE0, IcdSlaveTxLiteral = 0xDF, IcdSlaveTxBuffer = 0xDE,
               LoopBuffer = 0xDD, IcspStatesBuffer = 0xDC, PopDownloader = 0xDB,
               CoreInst18 = 0xDA, CoreInst24 = 0xD9, Nop24 = 0xD8, Visi24 = 0xD7,
               Rd2ByteBuffer = 0xD6, Rd2BitsBuffer = 0xD5, WriteBuffWordW = 0xD4,
               WriteBuffByteW = 0xD3, ConstWriteDl = 0xD2
};
...
enum StatusFlag { ButtonPressed = 0x0040, VppError = 0x0020, VddError = 0x0010, VddIsOn = 0x0002 };
