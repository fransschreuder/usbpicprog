...
// programming
  virtual bool readMemory(Pic::MemoryRangeType type, uint wordOffset, uint nbWords, Device::Array &data, const ::Programmer::VerifyData *vdata) = 0;
  virtual bool writeMemory(Pic::MemoryRangeType type, const Device::Array &data, uint wordOffset, uint nbWords) = 0;
  virtual bool eraseAll() = 0;

// debugging
  virtual bool readRegister(uint address, uint &value, uint nbBytes) = 0;
  virtual bool writeRegister(uint address, uint value, uint nbBytes) = 0;
  virtual bool resumeRun() = 0;
  virtual bool step() = 0;
  virtual bool haltRun() = 0;
  virtual uint getProgramCounter() = 0;
...
public:
  ...
  void prepareRange(Pic::MemoryRangeType type, const Device::Array &data,
