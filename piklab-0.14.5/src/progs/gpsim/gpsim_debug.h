...
public:
  ...
  virtual bool setBreakpoints(const QValueList<uint> &list);
  virtual bool readRegister(const Register::TypeData &data, uint &value);
  virtual bool writeRegister(const Register::TypeData &data, uint value);
...
private:
  ...
  bool getRegister(const QString &name, uint &value);
  bool setRegister(const QString &name, uint value);
  bool getRegister(uint address, uint &value);
  bool setRegister(uint address, uint value);
  ...
  bool readWreg(uint &value);
  bool writeWreg(uint value);
};
