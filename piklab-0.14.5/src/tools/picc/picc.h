...
{
public:
  virtual QString baseExecutable(bool) const { return "picl"; }
...
{
public:
  virtual QString baseExecutable(bool) const { return "picc"; }
...
{
public:
  virtual QString baseExecutable(bool) const { return "picc18"; }
