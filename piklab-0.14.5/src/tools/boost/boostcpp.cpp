...
//----------------------------------------------------------------------------
QString Boost::GroupCpp::downloadText() const
{
  return i18n("<a href=\"http://www.sourceboost.com/Products/BoostCpp/Overview.html\">BoostC++ Compiler</a> is a C compiler distributed by SourceBoost Technologies.");
}
...
Tool::Base *Boost::GroupCpp16::baseFactory(Tool::Category category) const
{
  ...
  if ( category==Tool::Compiler ) return new Boost::CompilerCpp16;
  return 0;
}
...
Tool::Base *Boost::GroupCpp18::baseFactory(Tool::Category category) const
{
  ...
  if ( category==Tool::Compiler ) return new Boost::CompilerCpp18;
  return 0;
}
