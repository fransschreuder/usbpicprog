...
QString CCSC::CompileFile::familyName() const
{
  ...
  switch (pdata->architecture()) {
    case Pic::Arch_10X: return "B";
    case Pic::Arch_16X: return "M";
    case Pic::Arch_17X: return "7";
    case Pic::Arch_18C:
    case Pic::Arch_18F:
    case Pic::Arch_18J: return "H";
    case Pic::Arch_24F:
    case Pic::Arch_24H:
    case Pic::Arch_30X: break;
...
QStringList CCSC::CompileFile::genericArguments(const Compile::Config &config) const
{
  ...
  args += "+F%FAMILY";
  if ( isVersion3 ) args += config.includeDirs(Tool::Compiler, "I=\"", "\"");
  else args += config.includeDirs(Tool::Compiler, "I+=\"", "\"");
