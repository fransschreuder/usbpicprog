...
public:
  ...
  virtual QString listviewGroup(const QString &device) const { return i18n("24 EEPROM"); }
  virtual Device::MemoryEditor *createConfigEditor(Device::Memory &, QWidget *) const { return 0; }
  virtual KPopupMenu *createWatchPopup(QWidget *, QValueVector<Register::TypeData> &) const { return 0; }
