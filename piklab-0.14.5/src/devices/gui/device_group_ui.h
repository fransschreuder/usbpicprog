...
public:
  ...
  virtual QString listviewGroup(const QString &device) const = 0;
  virtual MemoryEditor *createConfigEditor(Device::Memory &memory, QWidget *parent) const = 0;
  virtual KPopupMenu *createWatchPopup(QWidget *parent, QValueVector<Register::TypeData> &ids) const = 0;
