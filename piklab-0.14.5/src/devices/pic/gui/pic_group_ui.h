...
public:
  ...
  virtual QString listviewGroup(const QString &device) const { return device.mid(0, 2); }
  virtual Device::MemoryEditor *createConfigEditor(Device::Memory &memory, QWidget *parent) const;
  virtual KPopupMenu *createWatchPopup(QWidget *parent, QValueVector<Register::TypeData> &ids) const;
