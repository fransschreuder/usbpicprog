...
BuildRequires:  qt3-devel libusb-devel libreadline-devel
...
%__install -m 755 piklab-prog.1 %buildroot/%_mandir/piklab-prog.1
%__install -m 755 piklab-hex.1 %buildroot/%_mandir/piklab-hex.1
